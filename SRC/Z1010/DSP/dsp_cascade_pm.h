// Generated by pmgen.py from techlibs/dsp_cascade.pmg
      ...
      for (int i = 1; i < GetSize(longest_chain); i++) {
        ...
        if (i % MAX_DSP_CASCADE > 0) {
          ...
          if (BREG >= 0) {
            ...
            if (dsp->type.in(id_b_DSP48A, id_b_DSP48A1)) {
              // According to UG389 p9 [https://www..com/support/documentation/user_guides/ug389.pdf]
            ...
            if (dsp->type.in(id_b_DSP48E1)) {
              ...
              // According to UG389 p13 [https://www..com/support/documentation/user_guides/ug389.pdf]
